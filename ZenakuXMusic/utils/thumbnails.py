...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("ZenakuXMusic/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("ZenakuXMusic/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("ZenakuXMusic/assets/assets/font3.ttf", 45)


    circle_thumbnail = crop_center_circle(youtube, 420, 20)
    circle_thumbnail = circle_thumbnail.resize((420, 420))
    ...
    play_icons = Image.open("ZenakuXMusic/assets/assets/play_icons.png")
